    ...
    var a = "d3pie",
        ...
        j = {
            ...
            fadeInLabelsAndLines: function (a) {
                ...
                setTimeout(function () {
                    ...
                    d3.selectAll("." + a.cssPrefix + "labelGroup-outer").style("opacity", function (b, c) {
                        var d = a.options.labels.outer.hideWhenLessThanPercentage;
                        return null !== d && b.percentage < d ? 0 : 1
                    }), d3.selectAll("." + a.cssPrefix + "labelGroup-inner").style("opacity", function (b, c) {
                        var d = a.options.labels.inner.hideWhenLessThanPercentage;
                        return null !== d && b.percentage < d ? 0 : 1
                    }), d3.selectAll("g." + a.cssPrefix + "lineGroups").style("opacity", 1), g.isFunction(a.options.callbacks.onload) && setTimeout(function () {
                        try {
        ...
        k = {
            ...
            create: function (a) {
                ...
                }).style("stroke", e).style("stroke-width", 1).transition().duration(1).attr("data-index", function (a, b) {
                    return b
            ...
            openSegment: function (a, b) {
                a.isOpeningSegment || (a.isOpeningSegment = !0, k.maybeCloseOpenSegment(), d3.select(b).attr("transform", function (b, c) {
            ...
            closeSegment: function (a, b) {
                d3.select(b).attr("transform", "translate(0,0)").on("end", function (c, d) {
        ...
        m = {
            ...
            showTooltip: function (a, b) {
                ...
                m.currentTooltip === b && (c = 1), m.currentTooltip = b, d3.select("#" + a.cssPrefix + "tooltip" + b).style("opacity", function () {
                    return 1
                }), m.moveTooltip(a)
            },
